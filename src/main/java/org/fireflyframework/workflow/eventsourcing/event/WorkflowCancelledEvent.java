...
/**
 * Domain Event: A workflow execution has been cancelled.
 * <p>
...
@NoArgsConstructor
@AllArgsConstructor
public class WorkflowCancelledEvent extends AbstractDomainEvent {

    /**
     * The reason for cancelling the workflow execution.
     */
