...
/**
 * Domain Event: A suspended workflow execution has been resumed.
 * <p>
 * This event is recorded when a previously suspended workflow instance
...
@Getter
@NoArgsConstructor
public class WorkflowResumedEvent extends AbstractDomainEvent {
}
