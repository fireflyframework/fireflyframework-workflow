...
/**
 * Integration tests for Redis caching using fireflyframework-cache with Testcontainers.
 * <p>
 * These tests verify that the workflow engine can successfully use the
 * fireflyframework-cache library with a real Redis instance running in a container.
 */
@Testcontainers
...
@DisplayName("Redis Cache Integration Tests (fireflyframework-cache)")
